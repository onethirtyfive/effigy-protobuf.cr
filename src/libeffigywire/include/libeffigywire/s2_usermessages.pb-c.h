...
#ifndef PROTOBUF_C_s2_5fusermessages_2eproto__INCLUDED
#define PROTOBUF_C_s2_5fusermessages_2eproto__INCLUDED
...
typedef struct _CUserMsgCustomGameEventClientToServer CUserMsgCustomGameEventClientToServer;
typedef struct _CUserMsgCustomGameEventServerToClient CUserMsgCustomGameEventServerToClient;
typedef struct _CUserMsgTrackedControllerInputClientToServer CUserMsgTrackedControllerInputClientToServer;
...
typedef enum _EBaseUserMessages {
  ...
  EBASE_USER_MESSAGES__UM_CustomGameEvent_ClientToServer = 147,
  EBASE_USER_MESSAGES__UM_CustomGameEvent_ServerToClient = 148,
  EBASE_USER_MESSAGES__UM_TrackedControllerInput_ClientToServer = 149,
...
struct  _CUserMsgCustomGameEventClientToServer
{
  ProtobufCMessage base;
  char *event_name;
  protobuf_c_boolean has_data;
...
#define CUSER_MSG__CUSTOM_GAME_EVENT__CLIENT_TO_SERVER__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&cuser_msg__custom_game_event__client_to_server__descriptor) \
    , NULL, 0,{0,NULL} }


struct  _CUserMsgCustomGameEventServerToClient
{
  ProtobufCMessage base;
  char *event_name;
  protobuf_c_boolean has_data;
...
#define CUSER_MSG__CUSTOM_GAME_EVENT__SERVER_TO_CLIENT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&cuser_msg__custom_game_event__server_to_client__descriptor) \
    , NULL, 0,{0,NULL} }


struct  _CUserMsgTrackedControllerInputClientToServer
{
  ProtobufCMessage base;
  protobuf_c_boolean has_data;
  ProtobufCBinaryData data;
};
#define CUSER_MSG__TRACKED_CONTROLLER_INPUT__CLIENT_TO_SERVER__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&cuser_msg__tracked_controller_input__client_to_server__descriptor) \
    , 0,{0,NULL} }
...
void   cuser_msg__hud_error__free_unpacked
                     (CUserMsgHudError *message,
                      ProtobufCAllocator *allocator);
/* CUserMsgCustomGameEventClientToServer methods */
...
void   cuser_msg__custom_game_event__client_to_server__free_unpacked
                     (CUserMsgCustomGameEventClientToServer *message,
                      ProtobufCAllocator *allocator);
/* CUserMsgCustomGameEventServerToClient methods */
...
void   cuser_msg__custom_game_event__server_to_client__free_unpacked
                     (CUserMsgCustomGameEventServerToClient *message,
                      ProtobufCAllocator *allocator);
/* CUserMsgTrackedControllerInputClientToServer methods */
...
typedef void (*CUserMsgHudError_Closure)
                 (const CUserMsgHudError *message,
                  void *closure_data);
typedef void (*CUserMsgCustomGameEventClientToServer_Closure)
                 (const CUserMsgCustomGameEventClientToServer *message,
                  void *closure_data);
typedef void (*CUserMsgCustomGameEventServerToClient_Closure)
                 (const CUserMsgCustomGameEventServerToClient *message,
                  void *closure_data);
typedef void (*CUserMsgTrackedControllerInputClientToServer_Closure)
                 (const CUserMsgTrackedControllerInputClientToServer *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor cuser_msg__custom_game_event__client_to_server__descriptor;
extern const ProtobufCMessageDescriptor cuser_msg__custom_game_event__server_to_client__descriptor;
extern const ProtobufCMessageDescriptor cuser_msg__tracked_controller_input__client_to_server__descriptor;

PROTOBUF_C__END_DECLS


#endif  /* PROTOBUF_C_s2_5fusermessages_2eproto__INCLUDED */
