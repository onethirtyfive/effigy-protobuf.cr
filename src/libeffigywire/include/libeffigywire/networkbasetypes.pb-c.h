...
typedef struct _CNETMsgFile CNETMsgFile;
...
typedef struct _CNETMsgReliableMessageEndMarker CNETMsgReliableMessageEndMarker;
...
typedef enum _NETMessages {
  ...
  NET__MESSAGES__net_ReliableMessageEndMarker = 14
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(NET__MESSAGES)
} NETMessages;
typedef enum _SIGNONSTATE {
  SIGNONSTATE__SIGNONSTATE_NONE = 0,
  SIGNONSTATE__SIGNONSTATE_CHALLENGE = 1,
  SIGNONSTATE__SIGNONSTATE_CONNECTED = 2,
  SIGNONSTATE__SIGNONSTATE_NEW = 3,
  SIGNONSTATE__SIGNONSTATE_PRESPAWN = 4,
  SIGNONSTATE__SIGNONSTATE_SPAWN = 5,
  SIGNONSTATE__SIGNONSTATE_FULL = 6,
  SIGNONSTATE__SIGNONSTATE_CHANGELEVEL = 7
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(SIGNONSTATE)
} SIGNONSTATE;
...
struct  _CMsgPlayerInfo
{
  ...
  size_t n_customfiles;
  uint32_t *customfiles;
  protobuf_c_boolean has_filesdownloaded;
  int32_t filesdownloaded;
};
...
{
  ProtobufCMessage base;
  protobuf_c_boolean has_transfer_id;
  int32_t transfer_id;
  char *file_name;
  protobuf_c_boolean has_is_replay_demo_file;
  protobuf_c_boolean is_replay_demo_file;
  protobuf_c_boolean has_deny;
  protobuf_c_boolean deny;
  protobuf_c_boolean has_is_file_requested;
  protobuf_c_boolean is_file_requested;
};
#define CNETMSG__FILE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&cnetmsg__file__descriptor) \
...
#define CNETMSG__SPAWN_GROUP__LOAD__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&cnetmsg__spawn_group__load__descriptor) \
    , NULL, NULL, NULL, 0,0, 0,0, NULL, NULL, 0,{0,NULL}, 0,0, 0,0, 0,0, NULL, NULL, 0,0, 0,0, 0,0 }
...
struct  _CNETMsgReliableMessageEndMarker
{
  ProtobufCMessage base;
};
#define CNETMSG__RELIABLE_MESSAGE_END_MARKER__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&cnetmsg__reliable_message_end_marker__descriptor) \
     }
...
void   csvcmsg__game_session_configuration__free_unpacked
                     (CSVCMsgGameSessionConfiguration *message,
                      ProtobufCAllocator *allocator);
/* CNETMsgReliableMessageEndMarker methods */
...
typedef void (*CNETMsgDisconnect_Closure)
                 (const CNETMsgDisconnect *message,
                  void *closure_data);
typedef void (*CNETMsgFile_Closure)
                 (const CNETMsgFile *message,
                  void *closure_data);
...
typedef void (*CSVCMsgGameSessionConfiguration_Closure)
                 (const CSVCMsgGameSessionConfiguration *message,
                  void *closure_data);
typedef void (*CNETMsgReliableMessageEndMarker_Closure)
                 (const CNETMsgReliableMessageEndMarker *message,
                  void *closure_data);
...
extern const ProtobufCEnumDescriptor    signonstate__descriptor;
...
extern const ProtobufCMessageDescriptor cnetmsg__file__descriptor;
...
extern const ProtobufCMessageDescriptor cnetmsg__reliable_message_end_marker__descriptor;
