...
typedef struct _CDOTAMsgEnemyItemAlert CDOTAMsgEnemyItemAlert;
...
struct  _CDOTAMsgEnemyItemAlert
{
  ProtobufCMessage base;
...
#define CDOTAMSG__ENEMY_ITEM_ALERT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&cdotamsg__enemy_item_alert__descriptor) \
    , 0,0, 0,0 }
...
void   cdotamsg__item_alert__free_unpacked
                     (CDOTAMsgItemAlert *message,
                      ProtobufCAllocator *allocator);
/* CDOTAMsgEnemyItemAlert methods */
...
typedef void (*CDOTAMsgItemAlert_Closure)
                 (const CDOTAMsgItemAlert *message,
                  void *closure_data);
typedef void (*CDOTAMsgEnemyItemAlert_Closure)
                 (const CDOTAMsgEnemyItemAlert *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor cdotamsg__enemy_item_alert__descriptor;
