...
#include <libeffigywire/dota_modifiers.pb-c.h>
...
static const ProtobufCFieldDescriptor cdotamodifier_buff_table_entry__field_descriptors[31] =
{
  {
    "entry_type",
    1,
